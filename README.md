# GSbCM: Greg's Sportsbook Core Model
...
To protect the GSbCM core profit, all speculative "Gems" use fractional units. *Stakes will be updated periodically.*

| Asset Class | Strategy | Stake | Logic |
| :--- | :--- | :--- | :--- |
| **GSbCM Straights** | Core Engine | 1.0 Unit ($1.00) | Data-driven market signals. |
| **PrizePicks Flex** | Ceiling Growth | 1.0 Unit ($1.00) | Top +EV alignment. |
| **SGP Storyteller** | Speculative | 0.10 Units ($0.10) | **Boost-Only.** Must have %+ promo. |
| **MLB HR Parlays** | High Variance| 0.10 Units ($0.10) | Parlay + RR by 2s/3s. |
...
**Target Window:** 14 Graded Days (Starts April 24, 2026; Ends approx. May 8, 2026)
